...
public class Fase extends JPanel implements ActionListener {
	...
	public Fase() {
		...
		ImageIcon ref=new ImageIcon("res\\1920x1080-black-solid-color-background.jpg");
		fundo=ref.getImage();	
	...
	public void paint(Graphics g) {
		...
		if(emJogo) {
			...
			ImageIcon fimDeJogo= new ImageIcon("res\\015.png");
	...
	public void checarColisoes() {
		...
		for(int i=0;i<enemy1.size();i++) {
			Enemy1 tempEnemy=enemy1.get(i);
			formaEnemy1=tempEnemy.getBounds();
